...
# Susceptibility function (piecewise)
...
L_val = np.arange(5, 41, 1) # Range of lattice sizes
...
for n_side in L_val:
    ...
    for n in range(len(T_val)):
        ...
        E_n = -2 * n_side**2 * J # Initial energy (cold start)
        ...
        # Specific Heat and Susceptibility via fluctuations
    ...
    # Fit Specific Heat peak to extract maximum value
    ...
    # Save data for current lattice size
...
# Save aggregated max values for Finite Size Scaling analysis
